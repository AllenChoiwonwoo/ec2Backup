...
# URL = 'http://xecond.co.kr/product/list.html?cate_no=64' #테스트용 37개
URL = 'http://xecond.co.kr/' #메인용 300개
...
# for tag in soup.select('div.xans-element-.xans-product.xans-product-listnormal.ec-base-product > ul > li'):
    # 테스트용 (아웃터 - 제킷 ) 37 개 크롤링
for tag in soup.select('ul[class="prdList grid4 main"] > li'):
    # 메인용 (메인페이지) 300개 크롤링
